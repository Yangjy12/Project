...
func main() {
	 ...
	 */
	 //1.路径
	 fileName1:="E:\\笔记本的\\Golang-100-Days-master\\ab.txt"
	 fileName2:="bb.txt"
	 fmt.Println(filepath.IsAbs(fileName1)) //true
	 fmt.Println(filepath.IsAbs(fileName2)) //false
	 fmt.Println(filepath.Abs(fileName1))
	 fmt.Println(filepath.Abs(fileName2)) // E:\笔记本的\Golang-100-Days-master\bb.txt <nil>
	...
	fmt.Println("获取父目录：",path.Join(fileName1,".."))
	 ...
	 fmt.Println("文件夹创建成功。。")
	 err3 :=os.MkdirAll("/Users/ruby/Documents/pro/a/cc/dd/ee",os.ModePerm)
	 if err3 != nil{
	 ...
	 */
	 ...
	 //6.删除文件或文件夹：
	 //删除文件
	err1 :=  os.Remove("/Users/ruby/Documents/pro/a/aa.txt")
	if err1 != nil{
	...
	fmt.Println("删除文件成功。。")
	//删除目录
	err2 :=  os.RemoveAll("/Users/ruby/Documents/pro/a/cc")
	if err2 != nil{
